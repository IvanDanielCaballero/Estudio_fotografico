...
<body>
  ...
  <div class="page"></a>
    ...
    <!-- Breadcrumbs-->
    <section class="breadcrumbs-custom bg-image context-dark" style="background-image: url(https://images.pexels.com/photos/1587927/pexels-photo-1587927.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2);">
            ...
            <tbody>
              <?php foreach ($eventos as $evento) : ?>
                <tr>
                  ...
                  <td>
                    <button id="NuevoPresupuesto_<?php echo htmlspecialchars($evento['id_evento']); ?>" type="button" class="btn btn-warning">
                  ...
                  <td>
                    <button id="NuevoFactura_<?php echo htmlspecialchars($evento['id_evento']); ?>" type="button" class="btn btn-dark">
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-caret-up-square-fill" viewBox="0 0 16 16">
                        <path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2zm4 9h8a.5.5 0 0 0 .374-.832l-4-4.5a.5.5 0 0 0-.748 0l-4 4.5A.5.5 0 0 0 4 11" />
                      </svg>
                    </button>
        ...
        <div class="card_recopilar">
          ...
          <form id="form_recopilar" action="insertar_presupuesto.php" method="post">
            ...
            <div class="inputBox mb3">
              <input type="text" id="id_cliente" name="id_cliente" value="<?php echo htmlspecialchars($_GET['id']); ?>" readonly>
          ...
          <div class="row row-50">
            ...
            <div class="col-sm-6 col-md-5 col-lg-4">
              <div class="box-1">
                ...
                <ul class="list-sm">
                  <li class="object-inline"><span class="icon icon-md mdi mdi-map-marker text-gray-700"></span><a class="link-default" href="#">Calle San José <br> Puerta 3, Piso 2, Número
                      123.</a></li>
  ...
  <div class="preloader">
    <div class="preloader-logo"><img src="../images/logo-inverse-176x28.png" alt="" width="176" height="28" srcset="../images/logo-default-352x56.png 2x" />
    </div>
