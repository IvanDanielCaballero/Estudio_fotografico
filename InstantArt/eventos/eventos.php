          ...
          <form id="form_recopilar" action="insertar_presupuesto.php" method="post">
            ...
            <div class="inputBox mb3">
              <input type="text" id="id_evento_presupuesto" name="id_evento_presupuesto"
                value="<?php echo htmlspecialchars($evento['id_evento']); ?>" readonly>
...
<script>
  ...
  function insertar_presupuesto(e) {
    ...
    id_boton = e.target.getAttribute("id");
    id_evento = id_boton.split("_")[1]; // Extraer el ID del evento desde el ID del botón
    ...
    document.getElementById('id_evento_presupuesto').value = id_boton.split("_")[1];
  }
  ...
  function insertar_factura(e) {
    ...
    let id_evento_f = id_boton.split("_")[1]; // Extraer el ID del evento desde el ID del botón

    // Redirigir a la página de generación de factura con los IDs de cliente y evento
    window.location.href = 'factura.php?id_evento=' + id_boton.split("_")[1] + '&id_cliente=' + idCliente;
